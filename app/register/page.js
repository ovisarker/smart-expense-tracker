  ...
  return (
    <div className="min-h-screen grid place-items-center p-6">
      <form onSubmit={onSubmit} className="w-full max-w-md space-y-4 bg-white dark:bg-gray-900 p-6 rounded-2xl shadow">
        ...
        <input className="w-full border dark:border-gray-700 bg-transparent p-3 rounded-xl" placeholder="Name"
        ...
        <button className="w-full bg-black text-white p-3 rounded-xl">Sign up</button>
